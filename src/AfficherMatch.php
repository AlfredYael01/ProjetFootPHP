...
$res = $linkpdo->query('SELECT * FROM matchs ORDER BY dates,heure');
    ...
    echo"<td>Date</td><td>Heure</td><td>Nom de l'equipe adverse</td><td>Lieu de rencontre</td><td>Nom du stade</td><td>Resultat</td>";
...
echo "</table>";
$res->closeCursor();
echo "</br><div id=divModifier><a id=Supprimerboutton href = SupprimerMatch.php>Supprimer un match</a><a id=Ajouterboutton href=FormulaireAjouterUnMatch.php>Ajouter un match</a></div>";
